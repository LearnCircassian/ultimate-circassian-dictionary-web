...
export default function Policy() {
  return (
    <ContainerDiv className="m-8 p-4">
      ...
      <h2 className="mb-2 text-xl font-semibold">Interpretation and Definitions</h2>
      ...
      <h3 className="mb-2 text-lg font-semibold">Definitions</h3>
      ...
      <ul className="mb-4 list-inside list-disc">
        ...
        <li className="mb-2">
          <p>
            <strong>Application</strong> refers to All-In-One Circassian Dictionary, the software
        ...
        <li className="mb-2">
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to All-In-One Circassian
            Dictionary.
          </p>
        </li>
        <li className="mb-2">
      ...
      <h2 className="mb-2 text-xl font-semibold">Collecting and Using Your Personal Data</h2>
      <h3 className="mb-2 text-lg font-semibold">Types of Data Collected</h3>
      <h4 className="text-md mb-2 font-semibold">Personal Data</h4>
      <p className="mb-4">
      ...
      <h4 className="text-md mb-2 font-semibold">Usage Data</h4>
      ...
      <h3 className="mb-2 text-lg font-semibold">Use of Your Personal Data</h3>
      ...
      <h3 className="mb-2 text-lg font-semibold">Retention of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Transfer of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Delete Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Disclosure of Your Personal Data</h3>
      <h4 className="text-md mb-2 font-semibold">Business Transactions</h4>
      <p className="mb-4">
        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
        transferred. We will provide notice before Your Personal Data is transferred and becomes
        subject to a different Privacy Policy.
      </p>
      <h4 className="text-md mb-2 font-semibold">Law enforcement</h4>
      <p className="mb-4">
        Under certain circumstances, the Company may be required to disclose Your Personal Data if
        required to do so by law or in response to valid requests by public authorities (e.g. a
        court or a government agency).
      </p>
      <h4 className="text-md mb-2 font-semibold">Other legal requirements</h4>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Security of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h2 className="mb-2 text-xl font-bold">Links to Other Websites</h2>
      <p className="mb-4">
      ...
      <h2 className="mb-2 text-xl font-bold">Changes to this Privacy Policy</h2>
      <p className="mb-4">
