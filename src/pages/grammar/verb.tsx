  ...
  return (
    <section>
      ...
      <p className="mb-4">
        ...
        In the following English will be used to demonstrate that. 
        English is not a good example of showing those differences, as it has lost the marking which would differentiate between nominative and accusative cases, except in a few places like the pronouns. 
        But it will be enough to show the difference between accusative and ergative languages.
      </p>
      <p className="mb-4">
        Let&apos;s take the following Engish verbs <CText>to look</CText>, an intransitive verb, and <CText>to see Y</CText>, a transitive verb. In English the subject of both verbs is marked marked by the nominative case. However the verb <CText>to see <ColB>Y</ColB></CText> requires a direct object (<ColB>Y</ColB>), while the verb <CText>to look</CText> is not able to take a direct object. This amounts to that one can say <CText><ColR>You</ColR> see <ColB>me</ColB></CText>, but one canot say <CText>*<ColR>You</ColR> look <ColB>me</ColB></CText>. The asterisk (*) indicates that the sentence is ungrammatical. To make the sentence grammatical one has to use the preposition, like <CText><ColG>at</ColG></CText>, as in <CText><ColR>You</ColR> look <ColG>at me</ColG></CText>. But then the object <CText><ColG>me</ColG></CText> is not a direct object, but an indirect one, as it is the object of the preposition and not the verb itself.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Let&apos;s take the following Circassian verbs <CText ipa="pɬan">плъэн</CText> <TText>to look</TText> and <CText ipa="ɬaːʁʷən">лъагъун</CText> <TText>to see <ColR>Y</ColR></TText>. Except that the cases are different, they are exactly the same to their English counterparts in regards to the direct object. 
        One can say <CText ipa="wa sa səpɬaːʁʷənɕ"><ColB>уэ</ColB> <ColR>сэ</ColR> <ColR>сы</ColR><ColB>п</ColB>лъагъунщ</CText> <TText><ColB>You</ColB>&apos;ll see <ColR>me</ColR></TText>, as with the English equivalent one can only say <CText ipa="wa wəpɬanɕ"><ColR>уэ</ColR> <ColR>у</ColR>плэнщ</CText> <TText><ColR>You</ColR>&apos;ll look</TText>. 
        To add an object to <CText ipa="pɬan">плъэн</CText>, one has to to use a preverb (Circassiasn equivalent of preposition), like <CText ipa="taj-"><ColG>те-</ColG></CText>, which results into the verb <CText ipa="tajpɬan"><ColG>те</ColG>плъэн</CText>. 
        This allows to say <CText ipa="wa sa qəstajpɬanɕ"><ColR>уэ</ColR> <ColG>сэ</ColG> <ColR>у</ColR>къы<ColG>сте</ColG>плъэнщ</CText> <TText><ColR>You</ColR>&apos;ll look <ColG>down on me</ColG></TText>.
      </p>
      <p className="mb-4">
        ...
        For example, if we take the phrase <CText ipa="wa sa səpɬaːʁʷənɕ"><ColB>уэ</ColB> <ColR>сэ</ColR> <ColR>сы</ColR><ColB>п</ColB>лъагъунщ</CText> <TText><ColB>You</ColB>&apos;ll see <ColR>me</ColR></TText> and simply transform it the translation in our head to <TText><ColR>I</ColR>&apos;ll be seen <ColB>by you</ColB></TText>. 
